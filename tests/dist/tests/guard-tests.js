...
(0, tester_js_1.testEq)('Guard.isCollectionLike strict fails for larger tuple', index_js_1.Guard.is([index_js_1.Guard.isString, index_js_1.Guard.isNumber]).config(strict).guard(['hey', 23, true]), false);
...
(0, tester_js_1.testEq)('Guard.isCollectionLike loose works for larger tuple', index_js_1.Guard.is([index_js_1.Guard.isString, index_js_1.Guard.isNumber]).config(loose).guard(['hey', 23, true]), true);
...
(0, tester_js_1.testEq)('Guard.isCollectionLike strict fails for larger object', index_js_1.Guard.is({ a: index_js_1.Guard.isString, b: index_js_1.Guard.isNumber }).config(strict).guard({ a: 'hey', b: 9, c: true }), false);
...
(0, tester_js_1.testEq)('Guard.isCollectionLike loose works for larger object', index_js_1.Guard.is({ a: index_js_1.Guard.isString, b: index_js_1.Guard.isNumber }).config(loose).guard({ a: 'hey', b: 9, c: true }), true);
